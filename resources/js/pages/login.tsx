...
/**
 * Reaching this component at all already means the server didn't
 * recognize the current cookie (see IdentifyParent middleware) - so
 * there's no client-side "is this device already known" check needed
